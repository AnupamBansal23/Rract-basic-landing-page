...
const Home = () => {
  return (
    ...
    <div className="home2">
      ...
      <div>
        <p>
            We are your one and only solution to the tech problems you face every day. We are leading tech company whose aim to increase the problem solving ability in childrens.
        </p>
